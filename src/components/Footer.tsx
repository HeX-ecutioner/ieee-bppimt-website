...
import { ArrowUpRight, Mail, MapPin, Phone, Sparkles, X } from 'lucide-react';
import './Footer.css';
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { label: 'X', href: 'https://x.com/bppimtofficial', svg: <X /> },
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            >
              <h4 className="footer-card-title">
                ...
                <span className="footer-card-title-text">Quick Links</span>
              </h4>
          ...
          <div>
            ...
            >
              <h4 className="footer-card-title">
                <span className="footer-card-title-indicator"></span>
                <span className="footer-card-title-text">Resources</span>
              </h4>
              <ul className="footer-links-list">
                {[
            ...
            >
              ...
              <ul className="footer-contact-list">
                ...
                <li className="footer-contact-item footer-contact-item-center">
                  ...
                  <a href="mailto:info@bppimt.ac.in" className="footer-contact-link">info@bppimt.ac.in</a>
                </li>
              </ul>
            </motion.div>
          </div>
